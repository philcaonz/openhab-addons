 ...
 * @author Ivan Iliev - made sure resubscribe is only done when subscription
 *         ended CancelReason was EXPIRED or
 *         RENEW_FAILED
...
public class PanasonicUpnpIOService implements UpnpIOService, RegistryListener {
    ...
    private class UPNPPollingRunnable implements Runnable {
        ...
        @Override
        public void run() {
            // It is assumed that during addStatusListener() a check is made whether the
