...
/**
 * The {@link PanasonicTVHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Phillip Cao - Initial contribution
 */
@NonNullByDefault
@Component(configurationPid = "binding.panasonictv", service = ThingHandlerFactory.class)
public class PanasonicTVHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_SAMPLE.equals(thingTypeUID)) {
            return new PanasonicTVHandler(thing);
        }
